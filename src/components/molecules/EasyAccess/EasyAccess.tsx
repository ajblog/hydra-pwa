  ...
  return (
    <>
      <motion.div
        ...
        className={`bg-[#5B55ED] h-fit absolute top-0 left-[5%] px-4 pt-3 pb-6 z-[2000] flex flex-col gap-7 items-center justify-center rounded-b-full transition-all duration-700`}
      >
        <LogoIcon width="45" height="60" />
        {isOpen && <UsernameIcon width="40" height="40" />}
        {isOpen && (
