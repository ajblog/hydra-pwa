  ...
  return (
    <>
      <motion.div
        ...
        className={`bg-[#5B55ED] z-[10000] h-fit absolute top-0 left-[5%] px-4 pt-3 pb-6 flex flex-col gap-7 items-center justify-center rounded-b-full transition-all duration-700`}
      >
